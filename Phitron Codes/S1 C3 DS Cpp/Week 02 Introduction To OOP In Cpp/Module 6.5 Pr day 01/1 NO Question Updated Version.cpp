            ...
            /// 1 NO Question Updated Version.cpp
            //210722 9.00 am

        /// https://github.com/v-selfnet/Phitron/blob/main/Mod_6_5_Practic.cpp?fbclid=IwAR36Bh6cq1PuBLy0ERW1vn4V5I6x5D029mTTabQP8vYfGSgtlAxi64ohTRY
    #include <iostream>
    using namespace std;
    ...
    int main() {
        ...
        if (flag == 1)
        {
            cout<<"The updated marks of the requested student is: as follows:: "<<endl<<endl;
            for (i=0; i<n; i++)
            {
                if (mark == i)
                {
