            ...
            /// 19-1 Reverse a Linear Linked List (NonRecursive)
            // mod date: 090822, tuesday
            // complete date: 170822, wednesday
    ...
    */
    ...
    /// whole program
            ...
            /// 18 6 Deletion by a specific value unique list.cpp
            // 160822, 04.30 pm
    ...
    void insertAtSpecificPos(Node *&head, int pos, int val)
    {
        ...
        if (pos == 1) // if I put 0 here, then the first node pos will begin from 0
        {
            /*
