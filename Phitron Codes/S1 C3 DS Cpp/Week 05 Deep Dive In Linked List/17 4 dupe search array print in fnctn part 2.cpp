    ...
    void searchByValDupeList(Node *&head, int key)
    {
        ...
        while(tmp != NULL)
        {
            ...
            count++;                // count is increasing because we need to increasing count say 1 2 3 3 4 3 4 and finding 3, so if count is not increasing then it can not find the 4th and 6th 3's
        }
