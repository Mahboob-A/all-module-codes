    ...
    void mnHeapify(int arr[], int size, int currentParent)
    {
        ...
        {
            swap(arr[currentParent], arr[smallest]);
    ...
    */
    ...
    int main() {
        ...
        for(int i=nonLeafBegin; i>=0; i--)
            mnHeapify(arr, n, i); // i is the parent node
