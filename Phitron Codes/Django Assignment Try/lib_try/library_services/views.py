...
from lib_users.models import Book, BorrowBook, ReturnBook

from .models import BookRequest
from wallet.models import Wallet
from lib_users.models import Book
...
def return_book(request, book_id): 
        ...
        # for checking purpose :  change the condition to : ( provisional_return_date.date()  <= current_date.date() ) : 
        ...
        if is_fine_paid or  ( provisional_return_date.date()  <= current_date.date() ) :    
                ...
                request.session['fine_amount'] = abs(fine_amount)
