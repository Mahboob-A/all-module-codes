...
/*
Week 04 - Conncetion With Python and Project 
Module 14 : ER Diagram - BIKROY . COM DATABASE DESIGN 
Module date : 190323, Sunday
Module Watch Date : 080423, Saturday, 16'th Roja, 05.00 am to 05.00 pm 

In this module, an ER Diagram of BIKROY.COM is designed 
and below is it's DDL (data definition langulage, i.e the sql sonversion of 
the diagram). 

Always remenber that always create table for each relationship name between table 
and always create the independent table first than the dependent table. 
A table is independent if there are no foreign key in the table. So, create 
these types of table first then those table which contains foreign keys of 
other tables - i.e they are dependent on those tables.
