...
Watch Date: 071122, Sunday, 07.15 am
...
class AllAirports:
        ...
        def __init__(self) -> None:
                self.airports = None
                self.load_airport_data('./data/currencyrates.csv',
                                './data/countrycurrency.csv', './data/airport_data.csv')
        ...
        def load_airport_data(self, currencyrate_file_path, countrycurrency_file_path, airport_file_path):
                ...
                with open(airport_file_path, 'r', encoding='utf8') as file:
                        ...
                        try:
                                ...
                                for line in lines:
                                        country_name = line[3]   # getting the country name
                                        # getting the currency code
                                        country_currency_code = countryName_CurrencyCode[country_name]
