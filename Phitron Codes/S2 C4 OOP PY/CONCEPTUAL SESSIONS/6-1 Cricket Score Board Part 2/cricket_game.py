# Continue after 311022, Monday
# 071122, Monday 
# conceptual session 6 - 1
# cricket match score board system Part 2 
# https://github.com/Mahboob-A/Conceptual-Session-Batch-1-Oct-31-2022
...
class Innings:
    ...
    def bowl(self,status):  #status is a string 
