"""  
Week 05: Basic Shopping Cart Project
Date: 021122, Wednesday, 07.30 pm 
https://github.com/Mahboob-A/Conceptual-Session-Nov-02-2022-Batch-1/blob/main/index.py
"""
...
class ShoppingBasket:
    # {{"name":'rahat} }
    # [{"name": "rahat", "password": "123"}, {"name": "naim", "password": "124"}] --> dictionary
    user_lst = []
    # [["rahat", "1234"], ["naim", "1234"]] --> list
    # {"rahat" : [{"itemID" : 12, "price" : 200, "description" : 'abdc', "quantity" : 12}, {"itemID" : 13, "price" : 200, "description" : 'abdc', "quantity" : 12}]}
    user_ordered_data = {}
